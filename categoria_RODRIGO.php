...
<div class="container-fluid">
    ...
    <section class="container">
        <div class="row">  <!--  classe para separar em coluna engloba todo o php-->
                    ...
                    $sql = "SELECT * FROM livros WHERE genero='$categoria'";
                    ...
                    <div class="col-md-3 mt-5 align-self-xl-stretch">
                        ...
                        <section class="list-group align-self-xl-strech min-height">
                                  <span class="list-group-item list-group-item-secondary text-center"><img src="imagens/<?php echo $row['foto']; ?>" height="230"/><h3 class="min-height-titulos titulos-overflow"><?php echo $row['titulo']; ?></h3></span>
                                  <span class="list-group-item">
                                      ...
                                      <form method="get" action="produto.php?codigo={$id}">
