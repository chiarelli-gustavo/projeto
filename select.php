        ...
        <div class="row">  <!--  classe para separar em coluna engloba todo o php-->
                    ...
                    <div class="col-md-3 mt-5 align-self-xl-stretch">
                        ...
                        <section class="list-group align-self-xl-strech min-height">
                                  <span class="list-group-item list-group-item-secondary"><img src="imagens/<?php echo $row['foto']; ?>" height="200"/><h3 class="min-height-titulos titulos-overflow"><?php echo $row['titulo']; ?></h3></span>
                                  <span class="list-group-item">
                                      ...
                                      <form method="get" action="produto.php?id=<?php echo $row['$id']; ?>"> 
